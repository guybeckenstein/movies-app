...
public sealed class AuthService(ILogger<IAuthService> logger) : BaseService<IAuthService>(logger), IAuthService
{
    private readonly static User _user = new();
    private readonly static string _jwtToken = string.Empty;
